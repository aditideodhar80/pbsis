<%@ Page Language="VB" MasterPageFile="~/pbsmaster/Detail.master" AutoEventWireup="false" CodeFile="fmhi_distcoordprofilemenu.aspx.vb" Inherits="fmhiadmin_fmhi_distcoordprofilemenu" %>
 ...
 <tr>
          <td height="40" colspan="6" align="left" valign="middle" bgcolor="#92BC4E">
            <table width="60%" border="0">
                <tr>
                    <td align="left" ><asp:LinkButton ID="hyladdDistCoord" runat="server" Text="Add District Coordinator" NavigateUrl="~/fmhiadmin/fmhi_distcoord_addupdate.aspx"></asp:LinkButton></td>
